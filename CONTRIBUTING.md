...
- Clone the forked repository to your local development machine
   (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/Fabulous.MauiControls.git`).


### Environment Setup

To build Fabulous.MauiControls, you will need to install:
- the [.NET 7.0 SDK]
...
Once everything is set up, you can either open the Fabulous.MauiControls.sln file at the root with your preferred IDE and build the solution or execute the command `dotnet build Fabulous.MauiControls.sln`.
...
[GitHub issue]: https://github.com/fabulous-dev/Fabulous.MauiControls/issues
[GitHub issues]: https://github.com/fabulous-dev/Fabulous.MauiControls/issues
[GitHub releases page]: https://github.com/fabulous-dev/Fabulous.MauiControls/releases/new
[PRs]: https://github.com/fabulous-dev/Fabulous.MauiControls/pulls
