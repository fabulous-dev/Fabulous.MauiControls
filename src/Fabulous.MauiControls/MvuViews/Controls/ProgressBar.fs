...
module ProgressBarBuilders =
    type Fabulous.Maui.Mvu.View with
        ...
        static member inline ProgressBar<'msg>(progress: float) =
            WidgetBuilder<'msg, IFabMvuProgressBar>(ProgressBar.WidgetKey, ProgressBar.Progress.WithValue(progress))
...
type ProgressBarModifiers =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabMvuProgressBar>, value: ViewRef<ProgressBar>) =
