...
module LabelBuilders =
    type Fabulous.Maui.Components.View with
        ...
        static member inline Label<'msg>(text: string) =
            WidgetBuilder<'msg, IFabComponentLabel>(Label.WidgetKey, Label.Text.WithValue(text))
...
type LabelModifiers =
    ...
    [<Extension>]
    static member inline reference(this: WidgetBuilder<'msg, IFabComponentLabel>, value: ViewRef<Label>) =
