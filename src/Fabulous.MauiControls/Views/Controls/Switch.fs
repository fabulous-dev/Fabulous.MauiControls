...
type SwitchModifiers =
    ...
    [<Extension>]
    static member inline thumbColor(this: WidgetBuilder<'msg, #IFabSwitch>, light: FabColor, ?dark: FabColor) =
    ...
    [<Extension>]
    static member inline colorOn(this: WidgetBuilder<'msg, #IFabSwitch>, light: FabColor, ?dark: FabColor) =
