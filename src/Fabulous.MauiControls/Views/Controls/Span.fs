...
type SpanModifiers =
    ...
    [<Extension>]
    static member inline font(this: WidgetBuilder<'msg, #ISpan>, ?size: float, ?attributes: FontAttributes, ?fontFamily: string, ?autoScalingEnabled: bool) =
    ...
    static member inline gestureRecognizers<'msg, 'marker when 'marker :> ISpan>(this: WidgetBuilder<'msg, 'marker>) =
        WidgetHelpers.buildAttributeCollection<'msg, 'marker, Fabulous.Maui.IGestureRecognizer> Span.GestureRecognizers this
