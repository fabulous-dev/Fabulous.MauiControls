...
module HybridWebView =
    ...
    let DefaultFile = Attributes.defineBindableWithEquality<string> HybridWebView.DefaultFileProperty
    
    let HybridRoot = Attributes.defineBindableWithEquality<string> HybridWebView.HybridRootProperty
