...
type FabPositionChangedEventArgs(previousPosition: int, currentPosition: int) =
    inherit EventArgs()
...
type FabPicker() =
    ...
    let selectedIndexChanged = Event<EventHandler<FabPositionChangedEventArgs>, _>()
    ...
    override this.OnPropertyChanged(propertyName) =
        ...
        if propertyName = Picker.SelectedIndexProperty.PropertyName then
            selectedIndexChanged.Trigger(this, FabPositionChangedEventArgs(oldSelectedIndex, this.SelectedIndex))
