...
module VisualElementUpdaters =
    let updateVisualElementFocusFn oldValueOpt (newValueOpt: ValueEventData<bool, bool> voption) (node: IViewNode) =
...
module VisualElement =
    ...
    let FocusWithEventMsg =
        Attributes.defineSimpleScalar "VisualElement_FocusWithEventMsg" ScalarAttributeComparers.noCompare VisualElementUpdaters.updateVisualElementFocusMsg

    let FocusWithEventFn =
        Attributes.defineSimpleScalar "VisualElement_FocusWithEventFn" ScalarAttributeComparers.noCompare VisualElementUpdaters.updateVisualElementFocusFn
...
type VisualElementModifiers =
    ...
    /// <param name="onFocusChanged">Message to dispatch when the widget's focus state changes</param>
    [<Extension>]
    static member inline focus(this: WidgetBuilder<'msg, #IFabVisualElement>, value: bool, onFocusChanged: bool -> unit) =
        this.AddScalar(VisualElement.FocusWithEventFn.WithValue(ValueEventData.create value onFocusChanged))
