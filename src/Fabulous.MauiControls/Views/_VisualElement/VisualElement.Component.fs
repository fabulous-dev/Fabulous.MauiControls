...
module VisualElementComponentUpdaters =
...
type VisualElementComponentModifiers =
    ...
    [<Extension>]
    static member inline focus(this: WidgetBuilder<unit, #IFabVisualElement>, value: bool, onFocusChanged: bool -> unit) =
        this.AddScalar(VisualElementComponent.FocusWithEvent.WithValue(ValueEventData.create value onFocusChanged))