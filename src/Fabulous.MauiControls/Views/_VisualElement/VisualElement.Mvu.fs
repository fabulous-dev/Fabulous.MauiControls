...
module VisualElementMvuUpdaters =
    let updateVisualElementFocus oldValueOpt (newValueOpt: MsgValueEventData<bool, bool> voption) (node: IViewNode) =
...
module VisualElementMvu =
    let FocusWithEvent =
        Attributes.defineSimpleScalar "VisualElementMvu_FocusWithEvent" ScalarAttributeComparers.noCompare VisualElementMvuUpdaters.updateVisualElementFocus

[<Extension>]
type VisualElementMvuModifiers =
