...
module PointerGestureRecognizerMvu =
    let PointerEntered =
        Attributes.Mvu.defineEvent "PointerGestureRecognizerMvu_PointerEntered" (fun target -> (target :?> PointerGestureRecognizer).PointerEntered)

    let PointerExited =
        Attributes.Mvu.defineEvent "PointerGestureRecognizerMvu_PointerExited" (fun target -> (target :?> PointerGestureRecognizer).PointerExited)

    let PointerMoved =
        Attributes.Mvu.defineEvent "PointerGestureRecognizerMvu_PointerMoved" (fun target -> (target :?> PointerGestureRecognizer).PointerMoved)

    let PointerPressed =
        Attributes.Mvu.defineEvent "PointerGestureRecognizerMvu_PointerPressed" (fun target -> (target :?> PointerGestureRecognizer).PointerPressed)

    let PointerReleased =
        Attributes.Mvu.defineEvent "PointerGestureRecognizerMvu_PointerReleased" (fun target -> (target :?> PointerGestureRecognizer).PointerReleased)
