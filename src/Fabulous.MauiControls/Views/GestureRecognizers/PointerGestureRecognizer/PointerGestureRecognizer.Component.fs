...
module PointerGestureRecognizerComponent =
    let PointerEntered =
        Attributes.Component.defineEvent "PointerGestureRecognizerComponent_PointerEntered" (fun target -> (target :?> PointerGestureRecognizer).PointerEntered)

    let PointerExited =
        Attributes.Component.defineEvent "PointerGestureRecognizerComponent_PointerExited" (fun target -> (target :?> PointerGestureRecognizer).PointerExited)

    let PointerMoved =
        Attributes.Component.defineEvent "PointerGestureRecognizerComponent_PointerMoved" (fun target -> (target :?> PointerGestureRecognizer).PointerMoved)

    let PointerPressed =
        Attributes.Component.defineEvent "PointerGestureRecognizerComponent_PointerPressed" (fun target -> (target :?> PointerGestureRecognizer).PointerPressed)

    let PointerReleased =
        Attributes.Component.defineEvent "PointerGestureRecognizerComponent_PointerReleased" (fun target ->
            (target :?> PointerGestureRecognizer).PointerReleased)
