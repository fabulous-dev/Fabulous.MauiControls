...
module DragGestureRecognizerComponent =
    ...
    let DropCompleted =
        Attributes.Component.defineEvent<DropCompletedEventArgs> "DragGestureRecognizerComponent_DropCompleted" (fun target ->
...
module DragGestureRecognizerComponentBuilders =
    type Fabulous.Maui.View with
        ...
        static member inline DragGestureRecognizer(onDragStarting: DragStartingEventArgs -> unit) =
            WidgetBuilder<unit, IFabDragGestureRecognizer>(
                DragGestureRecognizer.WidgetKey,
                DragGestureRecognizerComponent.DragStarting.WithValue(onDragStarting)
            )
