...
module MultiPageOfPageMvu =
    let CurrentPageWithEvent =
        let name = "MultiPageOfPageMvu_CurrentPageWithEvent"
...
[<Extension>]
type MultiPageOfPageMvuModifiers =
    ...
    static member inline currentPage(this: WidgetBuilder<'msg, #IFabMultiPageOfPage>, currentPage: int, onCurrentPageChanged: int -> 'msg) =
        this.AddScalar(MultiPageOfPageMvu.CurrentPageWithEvent.WithValue(MsgValueEventData.create currentPage onCurrentPageChanged))
